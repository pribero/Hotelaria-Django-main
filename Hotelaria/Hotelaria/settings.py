"""
Django settings for Hotelaria project.
...
SECRET_KEY = 'django-insecure-78f2o+e^8p47hk&wu8xrm6g@+1oja^7tjju_ihiwv6jj#xuy+o'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Diretório de arquivos estáticos na raiz do projeto
]
